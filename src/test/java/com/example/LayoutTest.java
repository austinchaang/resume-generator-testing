...
public class LayoutTest {
    ...
    WebElement leftLayout;
    WebElement rightLayout;
    WebDriverWait wait;
    JavascriptExecutor js;
    By resumeOrientation;
    ...
    public void editExistingContentTopLayout() {
    ...
    public void topLayoutRemains() {
        ...
        // Verify that top layout is still present
        resumeOrientation = By.xpath("//div[contains(@class, 'resume') and contains(@class, 'top')]");
        WebElement topElement = driver.findElement(resumeOrientation);
        String elementClasses = topElement.getAttribute("class");
        Assert.assertEquals(elementClasses.contains("top"), true);
        Assert.assertEquals(elementClasses.contains("left"), false);
        Assert.assertEquals(elementClasses.contains("right"), false);
    }
    ...
    public void editExistingContentLeftLayout() {
        // Change layout to left
        ...
        leftLayout = wait.until(ExpectedConditions.elementToBeClickable(customize.pressLeftVisual()));
        js.executeScript("arguments[0].scrollIntoView(true);", leftLayout);
        js.executeScript("arguments[0].click();", leftLayout);
    ...
    public void leftLayoutRemains() {
        ...
        Assert.assertEquals(containerText.contains("Full-Stack Software Engineer"), false);
        Assert.assertEquals(containerText.contains("Top Hat Software Inc."), false);
        // Verify that left layout is still present
        resumeOrientation = By.xpath("//div[contains(@class, 'resume') and contains(@class, 'left')]");
        WebElement leftElement = driver.findElement(resumeOrientation);
        String elementClasses = leftElement.getAttribute("class");
        Assert.assertEquals(elementClasses.contains("top"), false);
        Assert.assertEquals(elementClasses.contains("left"), true);
        Assert.assertEquals(elementClasses.contains("right"), false);
    }

    @When("layout is changed to left and new content is added")
    public void addNewContentLeftLayout() {
        // Change layout to left
        customizeButton = wait.until(ExpectedConditions.elementToBeClickable(sidebar.pressCustomize()));
        js.executeScript("arguments[0].scrollIntoView(true);", customizeButton);
        js.executeScript("arguments[0].click();", customizeButton);
    ...
    public void verifyLeftLayoutRemains() {
        containerText = resumeContainer.getText();
        containerText = resumeContainer.getText();
        // Education tests
        Assert.assertEquals(containerText.contains("University of Saskatchewan"), true);
    ...
    public void leftLayoutAndNewContentEdited() {
        // Change layout to left
        customizeButton = wait.until(ExpectedConditions.elementToBeClickable(sidebar.pressCustomize()));
        js.executeScript("arguments[0].scrollIntoView(true);", customizeButton);
        js.executeScript("arguments[0].click();", customizeButton);
    ...
    public void editExistingContentRightLayout() {
        // Change layout to right
        customizeButton = wait.until(ExpectedConditions.elementToBeClickable(sidebar.pressCustomize()));
        js.executeScript("arguments[0].scrollIntoView(true);", customizeButton);
        js.executeScript("arguments[0].click();", customizeButton);

        rightLayout = wait.until(ExpectedConditions.elementToBeClickable(customize.pressRightVisual()));
        js.executeScript("arguments[0].scrollIntoView(true);", rightLayout);
        js.executeScript("arguments[0].click();", rightLayout);
    ...
    public void rightLayoutRemains() {
        containerText = resumeContainer.getText();
        // Personal Details tests
        Assert.assertEquals(containerText.contains("Brian Garrovillas"), true);
        Assert.assertEquals(containerText.contains("Software Test Engineer"), true);
        ...
        Assert.assertEquals(containerText.contains("Full-Stack Software Engineer"), false);
        Assert.assertEquals(containerText.contains("Top Hat Software Inc."), false);
        // Verify that right layout is still present
        resumeOrientation = By.xpath("//div[contains(@class, 'resume') and contains(@class, 'right')]");
        WebElement rightElement = driver.findElement(resumeOrientation);
        String elementClasses = rightElement.getAttribute("class");
        Assert.assertEquals(elementClasses.contains("top"), false);
        Assert.assertEquals(elementClasses.contains("left"), false);
        Assert.assertEquals(elementClasses.contains("right"), true);
    }

    @When("layout is changed to right and new content is added")
    public void addNewContentRightLayout() {
        // Change layout to right
        customizeButton = wait.until(ExpectedConditions.elementToBeClickable(sidebar.pressCustomize()));
        js.executeScript("arguments[0].scrollIntoView(true);", customizeButton);
        js.executeScript("arguments[0].click();", customizeButton);
    ...
    public void verifyRightLayoutRemains() {
        containerText = resumeContainer.getText();
        containerText = resumeContainer.getText();
        // Education tests
        Assert.assertEquals(containerText.contains("University of Saskatchewan"), true);
    ...
    public void rightLayoutAndNewContentEdited() {
        // Change layout to right
        customizeButton = wait.until(ExpectedConditions.elementToBeClickable(sidebar.pressCustomize()));
        js.executeScript("arguments[0].scrollIntoView(true);", customizeButton);
        js.executeScript("arguments[0].click();", customizeButton);
    ...
    public void verifyRightRemains() {
        containerText = resumeContainer.getText();
        // Education tests
        Assert.assertEquals(containerText.contains("University of Waterloo"), true);
        Assert.assertEquals(containerText.contains("Bachelor in Engineering"), true);
